...
location_table = [
    ...
    LocInfo('L1 KillAll: Bomb Ammo',           RID.LEVEL_1_R,      ['kill'], 'Kill all enemies in a room in Level 1'), #4x77
    ...
    LocInfo('L1 KillAll: Boss Key',            RID.LEVEL_1_R,      ['kill','bkey','wpn_restr','no_arrow','no_fire','no_wand'], 'Kill all enemies in a room in Level 1'), #4x68
    ...
    LocInfo('L5 KillAll: Compass',             RID.LEVEL_5,        ['kill','compass'], 'Kill all enemies in a room in Level 5'), #5x6D
    LocInfo('L5 KillAll: Bomb Ammo',           RID.LEVEL_5,        ['kill'], 'Kill all enemies in a room in Level 5'), #5x7A
    LocInfo('L5 KillAll: Hidden LKey',         RID.LEVEL_5,        ['kill','bomb','key'], 'Bomb the wall in Level 5, and kill the enemies inside'), #5x6A
    LocInfo('L5 KillAll: Map',                 RID.LEVEL_5_U,      ['kill','map'], 'Kill all enemies in a room in Level 5'), #5x6B
    LocInfo('L5 KillAll: Escape Spell',        RID.LEVEL_5_U,      ['kill'], 'Kill all enemies in a room in Level 5'), #5x6C
    LocInfo('L5 KillAll: Bottle',              RID.LEVEL_5_U,      ['kill'], 'Kill all enemies in a room in Level 5'), #5x7B
    LocInfo('L5: Bracelet 2',                  RID.LEVEL_5_U,      ['wpn','heavy'], 'Kill the golden Goriya and push the heavy block to access the bottom room'), #5x7D
    LocInfo('L5 KillAll: Magic Ring',          RID.LEVEL_5_U,      ['kill'], 'Kill all enemies in a room in Level 5'), #5x5D
